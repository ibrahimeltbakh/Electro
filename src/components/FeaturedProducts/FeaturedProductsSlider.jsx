...
import { FaArrowLeft, FaArrowRight, FaShoppingCart, FaHeart, FaEye, FaStar } from 'react-icons/fa';
...
const FeaturedProductsSlider = () => {
  ...
  return (
    <div className="py-16 overflow-hidden bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-10">
          ...
          >
            <div className="bg-blue-600 text-white p-3 rounded-lg rotate-3 shadow-lg">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Handpicked products curated for you</p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <Link to="/shop" className="inline-flex items-center text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors">
