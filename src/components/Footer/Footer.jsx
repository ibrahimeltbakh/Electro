...
const Footer = () => {
  ...
  return (
    <footer
      className="w-full bg-gray-50 text-black dark:bg-gray-900 dark:text-white"
    ...
    >
      <div className="max-w-screen-xl mx-auto px-4 py-10">
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-1/4">
            ...
            <div className="flex gap-4 text-black  dark:text-white">
              <Link to="/" className="text-blue-500 hover:text-blue-700 transition-colors duration-300 text-2xl">
                <FaTwitter />
              </Link>
              <Link to="/" className="text-blue-600 hover:text-blue-800 transition-colors duration-300 text-2xl">
                <FaFacebook />
              </Link>
              <Link to="/" className="text-pink-500 hover:text-pink-700 transition-colors duration-300 text-2xl">
                <FaInstagram />
              </Link>
            </div>
          </div>
          ...
          <div className="md:w-3/4 grid grid-cols-2 sm:grid-cols-4 gap-6">
            <div>
              <h5 className=" text-black  dark:text-white font-semibold mb-3">COMPANY</h5>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center  text-black  dark:text-white text-sm">
          <p className="mb-4 md:mb-0">Electro &copy; 2025-2026, All rights reserved</p>
