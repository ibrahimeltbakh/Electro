  ...
  useEffect(() => {
    if (data?.categories && productsData?.products) {
      ...
      const categoriesWithCount = data.categories.map(category => {
        const productCount = productsData.products.filter(product => 
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-indigo-600 py-16">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">Shop By Categories</h1>
            <p className="text-blue-100 text-lg max-w-2xl mx-auto mb-8">
              Browse our wide range of products organized by categories for easier shopping
            </p>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="mb-10">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">All Categories</h2>
          ...
          {filteredCategories.map((category, index) => (
            ...
            >
              <Link to={`/categories/${category.name}`}>
                <div className={`h-full bg-gradient-to-br ${bgColors[index % bgColors.length]} relative overflow-hidden`}>
                  {/* Category Image */}
