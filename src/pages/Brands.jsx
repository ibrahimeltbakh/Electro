        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 py-16">
                <div className="container mx-auto px-4">
                    ...
                    >
                        <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">Our Brands</h1>
                        <p className="text-blue-100 text-lg max-w-2xl mx-auto mb-8">
                            Discover premium quality products from the world's top electronics brands.
                        </p>
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="mb-10">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Browse Our Brands</h2>
                ...
                {filteredBrands?.length === 0 && (
                    <div className="text-center py-12">
                        <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">No brands found</h3>
