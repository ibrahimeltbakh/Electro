...
import { changePassword, updateUser, uploadProfileImage, getUserProfile } from '@/api/auth/auth';
  ...
  const imageMutation = useMutation({
    ...
    onSuccess: async () => {
      try {
        ...
        const imageUrl = updatedProfile.imageUrl || updatedProfile.image || updatedProfile.profileImage;
        if (imageUrl) {
